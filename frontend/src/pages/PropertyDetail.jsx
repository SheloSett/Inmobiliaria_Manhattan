...
export default function PropertyDetail() {
  ...
  useEffect(() => {
    setLoading(true);
    setNotFound(false);
    // "?src=public" (28/07/2026): le indica al backend que esta carga es una vista
    // real de un visitante (para las métricas de "propiedades más vistas" del
    // dashboard admin), a diferencia de AdminPropertyForm.jsx que pega al mismo
    // GET /properties/:id para precargar el formulario de edición y no debe contar.
  ...
  // propiedad ahora". sessionId en sessionStorage: un refresh de la página sigue
  // contando como el mismo viewer, no como uno nuevo.
  useEffect(() => {
    if (!property) return;
  ...
  // Trackea un clic en "Consultar por WhatsApp" (botón rápido o submit del
  // formulario) para "propiedades más consultadas" en el dashboard admin. Fire-and-
  // forget: no bloquea ni retrasa la apertura de WhatsApp. Agregado 28/07/2026.
